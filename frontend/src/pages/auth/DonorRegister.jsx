...
const PROVINCES = {
  ...
  Balochistan: ["Quetta", "Turbat", "Khuzdar", "Hub", "Gwadar", "Chaman", "Dera Murad Jamali"],
  KPK: ["Peshawar", "Mardan", "Abbottabad", "Mingora", "Kohat", "Dera Ismail Khan", "Nowshera"],
...
const validators = {
  ...
  phone: (value) => {
    ...
    if (!/^0[0-9]{10}$/.test(value)) return "Phone number must be 11 digits and start with 0";
    return "";
  },
  emergencyContact: (value) => {
    if (!value) return "Emergency contact is required";
    if (!/^0[0-9]{10}$/.test(value)) return "Emergency contact must be 11 digits and start with 0";
    return "";
  },
  dob: (value) => {
  ...
  "address.pincode": (value) => {
    ...
    if (!/^[0-9]{5}$/.test(value)) return "Postal code must be 5 digits";
    return "";
  },
};
                ...
                <div>
                  ...
                  >
                    ...
                    {formData.address.state &&
                      PROVINCES[formData.address.state].map(city => (
