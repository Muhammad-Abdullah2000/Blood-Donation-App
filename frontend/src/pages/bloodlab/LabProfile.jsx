    ...
    switch (path) {
      ...
      case "emergencyContact":
        if (value && !/^0[0-9]{10}$/.test(value)) {
          newErrors[path] = "Must be a valid 11-digit Pakistani phone number starting with 0";
        } else {
      ...
      case "address.pincode":
        if (value && !/^\d{5}$/.test(value)) {
          newErrors["address.pincode"] = "Must be a valid 5-digit postal code";
        } else {
                  ...
                  {["street", "city", "state", "pincode"].map((field) => (
                    <div key={field} className={field === "street" ? "md:col-span-2" : ""}>
                      ...
                      <input
                        ...
                        placeholder={`Enter ${field === "pincode" ? "postal code" : field === "state" ? "province" : field}`}
                      />
